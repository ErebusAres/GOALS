...
Goals.defaults = {
    ...
    settings = {
        ...
        combatLogTrackOutgoing = false,
        combatLogViewMode = "Show all",
        tableAutoLoadSeen = true,
        tableCombined = false,
        sudoDev = false,
        updateSeenVersion = 23,
        updateSeenMajor = 2,
        updateAvailableVersion = 0,
        updateAvailableMajor = 0,
        updateHasBeenSeen = false,
        autoMinimizeCombat = true,
        announceEncounterStarts = true,
        announceEncounterWipes = true,
        announceEncounterCompletions = true,
        announceEncounterProgress = true,
        combatLogHealing = false,
        combatLogShowHealing = true,
        combatLogShowDamageDealt = true,
        combatLogShowDamageReceived = true,
        combatLogShowOverheal = true,
        combatLogShowThreat = true,
        combatLogShowThreatAbilities = true,
        combatLogShowBossHealing = true,
        combatLogBroadcastCount = 9,
        combatLogBroadcastChannel = "SAY",
        combatLogBroadcastWhisperTarget = "",
        combatLogBigThreshold = 0,
        combatLogCombinePeriodic = false,
        combatLogCombineAll = false,
        ...
        combatWhtmPaused = false,
        combatWhtmTheme = "neutral",
        combatWhtmSoftRowColors = true,
        combatWhtmRowBgStyle = "event_tint",
        combatWhtmHideMinimapIcon = false,
        combatWhtmBossOnly = false,
        combatWhtmDirections = {
            incoming = true,
            outgoing = false,
            internal = false,
        },
